...
Las operaciones con dos relaciones reciben el nombre de \emph{operaciones binarias}. Podemos definir cada operación binaria para las relaciones $R(A_1,A_2,\ldots,A_n)$ y $S(B_1,B_2,\ldots,B_n)$ de tipo compatible (si tienen el mismo grado $n$ y si $dom(A_i)=dom(B_i)$ para $1\leq i\leq n$)
\begin{itemize}
