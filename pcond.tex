...
\end{equation}
Al tomar la expresión $P(A|B)$ y dividirla entre $P(A^\text{c}|B)$, ambos de la regla de Bayes; llegamos al \emph{teorema de Bayes en forma de apuestas}: para cualquier evento $A$ y $B$ con posibilidades positivas, las odds de $A$ after conditioning on*\notad{cómo se diceishon} $B$ son
\begin{equation}
