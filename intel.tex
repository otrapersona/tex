...
\emph{Inteligencia artificial} (IA) es \emph{el esfuerzo por automatizar tareas intelectuales normalmente realizadas por humanos}(\citeauthor{cho18}, \citeyear{cho18}), de este campo general se desprenden el \emph{aprendizaje maquinal} (AM) y \emph{aprendizaje profundo} (AP).
...
Tom Michell (\citeauthor{mich19}, \citeyear{mich19}) define aprendizaje maquinal como \emph{un programa de computadora aprende de experiencia $E$ con respecto a una tarea $T$ y una medición de rendimiento $P$, si su rendimiento en $T$, medido por $P$, mejora con $E$}.
