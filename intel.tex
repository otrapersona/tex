...
\end{tikzpicture}\caption[Inteligencia artificial]{Aprendizaje profundo, es un subcampo del aprendizaje maquinal, que a su vez es un subcampo de la inteligencia artificial}
\end{wrapfigure}

La \emph{inteligencia artificial} es definida como\label{fig:AI}
