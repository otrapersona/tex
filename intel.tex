...
\begin{wrapfigure}{c}{4.4cm}
	...
	\end{tikzpicture}\caption[Inteligencia Artificial]{Aprendizaje profundo, es un subcampo del aprendizaje maquinal, que a su vez es un subcampo de la inteligencia artificial}%{AP$\subset$AM$\subset$IA}
