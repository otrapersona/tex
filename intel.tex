...
\begin{wrapfigure}{R}{1.333cm}
	\begin{tikzpicture}
	\def\IA{(0,0) circle (1.333cm)}
	...
	\end{tikzpicture}
Aprendizaje profundo, es un subcampo del aprendizaje maquinal, que a su vez es un subcampo de la inteligencia artificial 123 123 123 123 123 123 123 123 123 123 123 123 123 123 123 123 123 123 123 123
\end{wrapfigure}\label{fig:AI}
