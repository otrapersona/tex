...
\end{equation}
En este caso las \colorbox{yellow}{odds} a posteriori $P(A|B)/P(A^c|B)$ son iguales a las \colorbox{yellow}{odds} a priori $P(A)/P(A^\Bur)$ por el factor $P(B|A)/P(B|A^c)$ lo que se le conoce en estadística como \emph{función de verosimilitud}.
