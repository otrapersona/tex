...
Supóngase que se realizan $n$ \colorbox{A^\text{c}ow}{procesos/ensayos/pruebas(trials)} Bernoulli independientes, cada uno con probabilidad $p$ de éxito. $X$ sea el número de éxitos, la distribución $X$ se llama \emph{distribución binominal} con parámetros $n$ y $p$; se escribe $X \sim Bin(p,n)$.
...
\begin{itemize}
    ...
    \end{equation}
\end{itemize}
\subsubsection {¿functions de random variables también?}
