...
$Bern(p)$ es la misma distribución que $Bin(1,p)$, Bernoulli es un caso especial de binominal y su función de probabilidad de $X$ es
\begin{equation}P(X=k)=(a \above 0pt b)\end{equation}
