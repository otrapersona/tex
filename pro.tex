...
\tableofcontents
\section {incompleto}
* congruencia, quitar lo quitable, introducción al-rel a db\\
* Linear Models and the Relevant Distributions and Matrix Algebra: -intervalos confianza, pruebas hipótesis *luego*\\
*Objetivos: gral, part, no me han dicho qué rollo con def del prob\\
-\\
* ML, NLP: Definición, Tipos.\\
CONTINUAR CON ESTA SECC, DARÁ PIE A QUÉ PARTES DEL MARCO TEÓRICO FALTAN SOBRAN, asumiré def del prob está bien hasta nuevo aviso\\
\pagebreak
