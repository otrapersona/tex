...
\author{Auxilio socorro}
\title{No le hagan caso a este formato}
\date{\today}
\usepackage{csquotes}
\usepackage{amsmath}
\usepackage{amssymb}
...
de RDB, ML, NLP, ...\\
se de puede desarrollar un/a\\
plataforma/ framework\\
genérica/ normalizada/ universal/ reutilizable/ estandarizada/ compatible\\
para/ con/ en casos de uso similares.
\section {Objetivos}
\section {Metas}
Cuenta la leyenda que la meta es el objetivo general
