...
\end{equation}
La esperanza de la continua función de distribución acumulada $f$ es
\begin{equation}
E(X)=\int_{-\infty}^{\infty}xf(x)dx
\end{equation}
la continua $U$ tiene dist unif en el intervalo $(a,b)$ si su función de distribución acumulada es
\begin{equation}
f(x)=\begin{cases}
1-q^{\lfloor x\rfloor+1}, \text{ si } x\geq 0;\\
0, \text{ si }x < 0,
