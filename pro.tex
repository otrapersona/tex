...
El valor esperado o media de una variable aleatoria discreta $X$ cuyos posibles valores distintos son $x_1,x_2.\ldots$ es defininda por
\begin{equation}
...
\begin{equation}
E(X)=\sum_{x}\overbrace{x}^\text{valor}\underbrace{P(X=x),}_{
    \begin{matrix}\text{función de }\\\text{probabilidad en $x$}\end{matrix}
}
\end{equation}
