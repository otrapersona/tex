...
\begin{abstract}
    Computer = good.
    \begin{figure}[h]
        \centering\includegraphics[width=.0625\textwidth]{computer}
...
\newpage
\renewcommand{\listfigurename}{Índice de figuras (imágenes, fotos, \includegraphics[width=1em]{shrug})} %cambiaelnombre
\listoffigures
