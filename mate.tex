...
\begin{figure}[H]
	\begin{subfigure}{.5\textwidth}\raggedright
		\includegraphics[width=.99\linewidth]{binominal.png}
Número de éxitos en $n$ ensayos de Bernoulli independientes con la misma probabilidad de éxito $p$.
		...
		\end{equation}
		\caption{Binominal}
	\end{subfigure}\raggedleft
	\begin{subfigure}{.5\textwidth}
		\includegraphics[width=.99\linewidth]{geom.png}
		Número de éxitos en $n$ ensayos de Bernoulli independientes con la misma probabilidad de éxito $p$.
		\begin{equation}
		\begin{matrix}
		f(X=k)=\binom{n}{x}p^xp^{n-x},\\
