Una \emph{variable aleatoria} (v.a.) es una función real $X: \Omega\mapsto\mathbb{R}$ tal que el conjunto $\{\omega\in\Omega:X(\omega)\in I\}$ es un evento de $\Omega$ para cada $I\subset\mathbb{R}$, en un espacio $\Omega$ hipotético. Se consideran \emph{variables aleatorias discretas} (v.a.d.) cuando su rango de valores $R_x$ es finito o contablemente infinito, las \emph{variables aleatorias continuas} (v.a.c.) pueden tomar cualquier valor real en un intervalo.
...
%\end{equation}
La forma más natural de expresar la distribución de variables aleatorias discretas es la \emph{función de probabilidad}\cite{blitz19}*, para una $X$ discreta con $R_x=\{x_1,x_2x_3,\ldots,x_n,\ldots\}$
