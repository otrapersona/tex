...
\end{matrix}
	...
	\end{subfigure}\qquad
\begin{subfigure}[t]{.5\textwidth}
	\includegraphics[width=.95\linewidth]{poisson.png}\caption{Poisson $\mathcal{P}(\lambda)$}
...
\begin{figure}[H]
	\begin{subfigure}[t]{.5\textwidth}
		\includegraphics[width=.95\linewidth]{uniforme.png}\caption{Uniforme $U[a,b]$}
		blablabla$a<b$
		\begin{equation}
		\begin{matrix}
	...
	\end{subfigure}\qquad
\begin{subfigure}[t]{.5\textwidth}
	\includegraphics[width=.95\linewidth]{normal.png}\caption{Normal $N(\mu,\sigma^2)$}
...
\end{subfigure}
	...
	\begin{subfigure}[t]{.5\textwidth}
		\includegraphics[width=.95\linewidth]{gama.png}\caption{$\Gamma$}
		blablabla
		\begin{equation},
		\begin{matrix}
		x\\
...
\begin{subfigure}[t]{.5\textwidth}
	...
	\begin{subfigure}[t]{.5\textwidth}
		\includegraphics[width=.95\linewidth]{epsilon_lambda.png}\caption{$\epsilon(\lambda)$}
		blablabla
		\begin{equation}
		\begin{matrix}
		x\\
