...
\begin{figure}[H]\caption[Distribuciones]{Existe diversidad de distribuciones para modelar v.a.s, a continuación se muestran las mas importantes de acuerdo a \citeauthor{bala20} (\citeyear{bala20}), siendo aptas para v.a.d.s hasta la distribución Normal, mientras que las v.a.c.s pueden ser modeladas desde la distribución Uniforme.}\label{FIG:DISTS}
