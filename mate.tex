...
cov(X,Y)=E[(X-EX)(Y-EY)],
\end{equation}
al referencia para la covarianza es conveniente escalarla de acuerdo a su desviación estándar, esto recibe el nombre de  \emph{coeficiente de correlación} $p$
\begin{equation}
\begin{matrix}
p=\frac{Cov(X,Y)}{\sigma_1\sigma_2},\qquad p=[-1,1],\\\\
\text{cuando}\begin{cases}p=-1,\quad\text{correlación lineal perfecta negativa}\\
p=0,\quad\ \text{no hay correlación lineal}\\
-1,\quad\text{correlación lineal perfecta negativa}\\
-1,\quad\text{correlación lineal perfecta negativa}\\
\end{cases}
\end{matrix}
\end{equation}
