...
Wackerly, Mendenhall III y Scheaffer \citeyear{wack09} consideran que
\begin{displayquote}
``parecería lógico usar $r$ como estadístico de prueba para probar hipótesis más generales acerca de $\rho$, pero la distribución de probabilidad para $r$ es difícil de obtener."
\end{displayquote}
En dichos casos, por ejemplo, cuando se tienen muestras moderadamente grandes podemos probar la hipótesis $H_0\colon \rho_1=\rho_0$ con una prueba Z
\begin{equation}
