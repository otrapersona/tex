...
Una \emph{variable aleatoria} es una función real $X: \Omega\mapsto\mathbb{R}$ tal que el conjunto $\{\omega\in\Omega:X(\omega)\in I\}$ es un evento de $\Omega$ para cada $I\subset\mathbb{R}$, en un espacio hipotético $\Omega$. Se consideran variables aleatorias discretas cuando su rango de valores $R_x$ es finito o contablemente infinito, las variables aleatorias continuas pueden tomar cualquier valor real en un intervalo.
