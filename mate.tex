...
Continuando con estadística, la \emph{varianza} de una v.a.d. $X$ indica la variabilidad de su distribución
\begin{equation}
\begin{matrix}
...
La covarianza de dos v.a.d.s $X$ y $Y$ cuyos valores esperados existen y son positivos, mide qué tanto o tan poco  tienen dependencia lineal, denotada $cov(X,Y)$ la covarianza de $X$ y $Y$ es definida como
\begin{equation}
cov(X,Y)=E[(X-EX)(Y-EY)]
\end{equation}
