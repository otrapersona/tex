...
\cline{2-7}
\multirow{3}{*}{$Tuplas\begin{cases}\\\\\end{cases}$}&\multicolumn{1}{| c }{MX01}& & 31-07-99 & & 0 &\multicolumn{1}{ r |}{}&\multicolumn{1}{ l }{}\\
\cline{2-7}
...
\cline{2-7}
\end{tabular}\caption{Tabla en una base de datos con algunas relaciones. La fila superior muestra las combinaciones de atributo-nombre/tipo-nombre para algunos atributos en la tabla y cada una de las filas siguientes es una tupla,  }\label{table:tupla}\end{table}