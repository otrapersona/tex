...
\cline{2-7}
\multicolumn{1}{ l }{Atributos $\{$}&\multicolumn{1}{| c |}{código} & \multicolumn{1}{ c |}{\footnotesize (CHAR)} & \multicolumn{1}{ c |}{fecha} & \multicolumn{1}{ c |}{\footnotesize (DATE)} & \multicolumn{1}{ c |}{estado} & \multicolumn{1}{ c |}{\footnotesize (INT)} \\
\cline{2-7}
\multicolumn{1}{ l }{}&\multicolumn{1}{| c }{MX01}& & 31-07-99 & & 0 &\multicolumn{1}{ r |}{}\\
\cline{2-7}
\multicolumn{1}{ l }{}&\multicolumn{1}{| c }{MX02}&&30-07-99&&0&\multicolumn{1}{ r |}{}\\
\cline{2-7}
\multicolumn{1}{ l }{}&\multicolumn{1}{| c }{MX03}&&31-07-99&&0&\multicolumn{1}{ r |}{}\\
\cline{2-7}
\end{tabular}\end{center}
\begin{center}\begin{tabular}{rcc|cc|cc|l}
\cline{2-7}
\multicolumn{1}{r}{$Atributos\begin{cases}\ \end{cases}$}&\multicolumn{1}{|c|}{código}&\multicolumn{1}{c|}{\footnotesize CHAR}&\multicolumn{1}{c|}{fecha}&\multicolumn{1}{c|}{\footnotesize DATE}&\multicolumn{1}{c|}{estado}&\multicolumn{1}{c|}{\footnotesize INT}&\multicolumn{1}{| l }{}\\
\cline{2-7}
\multirow{3}{*}{$\begin{cases}\\ \\ \\ \end{cases}$}&\multicolumn{1}{| c }{MX01}& & 31-07-99 & & 0 &\multicolumn{1}{ r |}{}&\multicolumn{1}{| l }{}\\
\cline{2-7}
&\multicolumn{1}{| c }{MX02}&&30-07-99&&0&\multicolumn{1}{ r |}{}&\multicolumn{1}{| l }{}\\
\cline{2-7}
&\multicolumn{1}{| c }{MX03}&&31-07-99&&0&\multicolumn{1}{ r |}{}&\multicolumn{1}{| l }{}\\
\cline{2-7}
\end{tabular}\end{center}