...
\end{enumerate}
Es importante comenzar definiendo los \emph{tipos}, ya que las relaciones se definen sobre ellos, los tipos son ``en esencia un conjunto finito de valores nombrados\textemdash todos los valores posibles de alguna categoría específica(...)''\cite{date12}.
